...
import it.uniroma2.isssr.gqm3.controller.ActivitiTaskService;
...
public class ActivitiTaskServiceImplementation implements ActivitiTaskService{
	...
	@Override
	public ResponseEntity<DTOResponseActivitiTask> updateActivitiTask(String id, String action) throws JsonRequestConflictException, JsonRequestException {
		// TODO Auto-generated method stub
	...
	public ResponseEntity<?> completeUserTasksWithStoredVariables(
			String taskId, String action) throws JsonParseException, JsonMappingException, IOException, JSONException, ActivitiGetException, JsonRequestException, JsonRequestConflictException {
