...
public interface Activiti2fase32 {
	...
	public boolean completeUserTasksWithStoredVariables(String id, String action) throws JsonParseException, JsonMappingException, IOException, JSONException, ActivitiGetException, JsonRequestException, JsonRequestConflictException;
	/**
