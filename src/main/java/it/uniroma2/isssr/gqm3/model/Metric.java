...
public class Metric {
    ...
    /**
     * @param busVersion The busVersion
     */
    @JsonProperty("busVersion")
    ...
    /**
     * @param secretToken The secretToken
     */
    @JsonProperty("secretToken")
    ...
    /**
     * @param releaseNote The releaseNote
     */
    @JsonProperty("releaseNote")
    ...
    /**
     * @param hasUserDefinedList The hasUserDefinedList
     */
    @JsonProperty("hasUserDefinedList")
    ...
    /**
     * @param userDefinedList The userDefinedList
     */
    @JsonProperty("userDefinedList")
    ...
    /**
     * @param lastVersionDate The lastVersionDate
     */
    @JsonProperty("lastVersionDate")
    ...
    /**
     * @param metricatorId The metricatorId
     */
    @JsonProperty("metricatorId")
